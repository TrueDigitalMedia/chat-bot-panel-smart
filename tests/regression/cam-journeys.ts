...
export async function seedQuota(): Promise<void> {
  ...
  await db.insert(quotaTargets).values([
    // Panamá — open NSE cell so C1 qualifies
    { country: 'Panamá', region: 'Panamá Metro', dimensionType: 'nse', dimensionValue: 'Nivel 2', targetCount: 100, active: true },
  ...
  await db.insert(quotaRegionCaps).values([
    { country: 'Panamá', region: 'Panamá Metro', capCount: null },
...
export const C2_guatemala_qualify: Journey = {
  ...
  channelUserId: 'reg-c2-guatemala',
...
export const C3_costarica_canton: Journey = {
  ...
  channelUserId: 'reg-c3-costarica',
...
export const C5_conflict_of_interest: Journey = {
  ...
  channelUserId: 'reg-c5-elsalvador',
...
export const C6_quota_exhausted: Journey = {
  ...
  channelUserId: 'reg-c6-nicaragua',
...
export const C8_gps_in: Journey = {
  ...
  channelUserId: 'reg-c8-guatemala',
...
export const C10_mid_survey_correction: Journey = {
  ...
  channelUserId: 'reg-c10-costarica',
