...
| V. Country-Scoped Recruitment Configuration | PASS — this feature is the first realization of Principle V. NSE scoring, questionnaire content, and geo catalog are Ecuador-specific data + one config object; shared code paths get a registry lookup, not a country branch. CAM regression suite proves other markets unchanged. |
